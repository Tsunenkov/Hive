...
*/
      ...
      */
        ...
        numLeft = random.nextInt(9); // генерация от 1 до 9

        img_left.setImageResource(array.images2[numLeft]);//достаем из массива картинку
        text_left.setText(array.texts2[numLeft]); //Достатем из массива текст

        numRight = random.nextInt(9); // генерация от 1 до 9
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            if (count==6){
                ...
                numLeft = random.nextInt(9); // генерация от 0 до 9
                img_left.setImageResource(array.images2[numLeft]);//достаем из массива картинку
                img_left.startAnimation(a);
                text_left.setText(array.texts2[numLeft]); //Достатем из массива текст

                numRight = random.nextInt(9); // генерация от 0 до 9
